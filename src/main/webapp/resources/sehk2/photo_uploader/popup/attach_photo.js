...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/resources/sehk2/file_uploader_html5.jsp'; 	//upload URL
...
//원본		sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 			sUrl  : '/resources/sehk2/file_uploader.jsp',
 	        sCallback : '/resources/sehk2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
