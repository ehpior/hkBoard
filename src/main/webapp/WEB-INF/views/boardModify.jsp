...
<main>
	...
	<form action="${pageContext.request.contextPath}/boardModifyResult" id="noticeWriteForm" method="POST">
		<table width="900" cellpadding="20px" cellspacing="0" border="1">
			...
			<tr>
				<td>writer</td>
				<td><input type="text" id="writer" name="writer" value="${login.accnt_id}"></td>
			</tr>
			<tr>
				<td>content<%--<br><c:out value="${dto.content}" escapeXml="true" /> --%></td>
...
nhn.husky.EZCreator.createInIFrame({ 
	...
	fOnAppLoad : function(){
		...
		//oEditors.getById["smartEditor"].exec("PASTE_HTML", ["testDB"]); //내용밀어넣기
	}
	}); 
